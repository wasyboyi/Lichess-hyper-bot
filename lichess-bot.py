...
def play_game(li, game_id, control_queue, engine_factory, user_profile, config, challenge_queue, correspondence_queue, logging_queue, logging_configurer, logging_level):
    ...
    conversation.send_reply(SendLine('player'), f'Made by @Chess_Streamer_007,All The Best @{opponent}')
    conversation.send_reply(SendLine('spectator'), f'Made by @Chess_Streamer_007,Good Luck @{opponent}')
